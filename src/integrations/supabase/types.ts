  ...
  public: {
    Tables: {
      ...
      event_assigned_users: {
        ...
        Relationships: [
          {
            foreignKeyName: "event_assigned_users_entity_id_fkey"
            columns: ["entity_id"]
            isOneToOne: false
            referencedRelation: "entities"
            referencedColumns: ["id"]
      ...
      event_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "event_items_entity_id_fkey"
            columns: ["entity_id"]
            isOneToOne: false
            referencedRelation: "entities"
            referencedColumns: ["id"]
      ...
      rental_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "rental_items_entity_id_fkey"
            columns: ["entity_id"]
            isOneToOne: false
            referencedRelation: "entities"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      is_entity_admin: { Args: { _user_id?: string }; Returns: boolean }
